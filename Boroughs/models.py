...
class Borough(models.Model):
    ...
    title = models.CharField(max_length=settings.BOROUGH_TITLE_MAX_LENGTH, unique=True, default="Title of your page.")
    ...
    zipcode = models.IntegerField(default=9401, blank=False, help_text="Add the zipcode of this borough")
